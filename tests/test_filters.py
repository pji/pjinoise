...
class GrainTestCase(ut.TestCase):
    def test_gaussianblur_process(self):
        """Given an image, add grain to the image."""
        exp = [
            [
                [0x00, 0x25, 0x47, 0x63, 0x73, 0x8f, 0xc7, 0xe1, 0xff],
                [0x1b, 0x36, 0x52, 0x73, 0x94, 0xb4, 0xe1, 0xff, 0xe3],
                [0x43, 0x5a, 0x97, 0xa8, 0xc6, 0xdb, 0xff, 0xe1, 0xca],
                [0x6e, 0x80, 0xab, 0xbc, 0xdc, 0xff, 0xe3, 0xc6, 0x97],
                [0x8f, 0x97, 0xb4, 0xe2, 0xff, 0xe5, 0xbd, 0xa2, 0x98],
                [0xa9, 0xc4, 0xda, 0xff, 0xdb, 0xcc, 0x9e, 0x85, 0x53],
                [0xc4, 0xe1, 0xff, 0xe2, 0xc6, 0xad, 0x69, 0x6d, 0x41],
                [0xe4, 0xff, 0xdb, 0xc6, 0xb1, 0x98, 0x50, 0x4c, 0x21],
                [0xff, 0xdf, 0xc0, 0xac, 0x7c, 0x6b, 0x3d, 0x26, 0x00],
            ],
            [
                [0x00, 0x1a, 0x37, 0x60, 0x80, 0xaf, 0xcc, 0xde, 0xff],
                [0x23, 0x33, 0x5f, 0x67, 0x9b, 0xb6, 0xda, 0xff, 0xe3],
                [0x37, 0x59, 0x8d, 0x9c, 0xba, 0xe1, 0xff, 0xdf, 0xb3],
                [0x5c, 0x6d, 0x9c, 0xc4, 0xdf, 0xff, 0xe0, 0xc4, 0xb2],
                [0x90, 0x98, 0xc7, 0xe5, 0xff, 0xe2, 0xc4, 0xa8, 0x6b],
                [0x8e, 0xbb, 0xdf, 0xff, 0xdf, 0xc5, 0x99, 0x6a, 0x6a],
                [0xc1, 0xe6, 0xff, 0xe4, 0xcb, 0xad, 0x8a, 0x6c, 0x4a],
                [0xe2, 0xff, 0xdf, 0xc7, 0xa6, 0x87, 0x71, 0x42, 0x1e],
                [0xff, 0xe5, 0xbf, 0x94, 0x8c, 0x5f, 0x3a, 0x1d, 0x00],
            ],
        ]
        kwargs = {
            'scale': .1,
...
class GrowTestCase(ut.TestCase):
    def test_grow_process(self):
        """Given an image, magnify the image by the given factor.
        """
        exp = [
            [
                [0xab, 0xb5, 0xc0, 0xcb, 0xd5, 0xe0, 0xea, 0xf5, 0xf1],
                [0xb5, 0xc0, 0xcb, 0xd5, 0xe0, 0xea, 0xf5, 0xff, 0xf5],
                [0xc0, 0xcb, 0xd5, 0xe0, 0xea, 0xee, 0xf1, 0xf5, 0xea],
                [0xcb, 0xd5, 0xe0, 0xea, 0xf5, 0xf1, 0xee, 0xea, 0xe0],
                [0xd5, 0xe0, 0xea, 0xf5, 0xff, 0xf5, 0xea, 0xe0, 0xd5],
                [0xe0, 0xea, 0xee, 0xf1, 0xf5, 0xea, 0xe0, 0xd5, 0xcb],
                [0xea, 0xf5, 0xf1, 0xee, 0xea, 0xe0, 0xd5, 0xcb, 0xc0],
                [0xf5, 0xff, 0xf5, 0xea, 0xe0, 0xd5, 0xcb, 0xc0, 0xb5],
                [0xf1, 0xf5, 0xea, 0xe0, 0xd5, 0xcb, 0xc0, 0xb5, 0xab],
            ],
            [
                [0xab, 0xb5, 0xc0, 0xcb, 0xd5, 0xe0, 0xea, 0xf5, 0xf1],
                [0xb5, 0xc0, 0xcb, 0xd5, 0xe0, 0xea, 0xf5, 0xff, 0xf5],
        ...
        obj = filters.Grow(**kwargs)
        act = test_filter_process(obj)
        self.assertListEqual(exp, act)
